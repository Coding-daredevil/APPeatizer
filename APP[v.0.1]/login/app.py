...
def dietbook():
    ...
    return render_template('dietbook.html', headings=headings, data=book, start_date=start_date_js, end_date=end_date_js, col="default")
